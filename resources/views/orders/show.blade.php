...
<div class="text-center py-5">
    ...
    <p>Terima kasih sudah beli di Toko Ikan Asin Bu Ema</p>
</div>
    ...
    <div class="col-md-8">
        <div class="card bg-dark text-white">
            <div class="card-body">
                ...
                <p><strong>Tanggal Pesanan:</strong>{{ $order->created_at->timezone('Asia/Jakarta')->translatedFormat('d F Y \p\a\d\a H:i') }} WIB </p>
